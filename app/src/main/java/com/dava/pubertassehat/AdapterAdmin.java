...
public class AdapterAdmin extends RecyclerView.Adapter<AdapterAdmin.Holder> {
    ...
    public AdapterAdmin(Context context, List<String> list) {
        this.list = list;
    ...
    @NonNull
    @Override
    public AdapterAdmin.Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = layoutInflater.inflate(R.layout.item_list, viewGroup, false);
        return new AdapterAdmin.Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterAdmin.Holder holder, int i) {
